...
/-!
# Setting up an attribute to simplify the AoC command processor

I'm getting tired of adding new entries to AoC.lean, so let's use an attribute to collect
each day's main entry points!
-/
